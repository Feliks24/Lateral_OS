...
* Buffer Overflow - Während der Verarbeitung kann der Zwischenspeicher überlaufen
    * Man könnte den Sender-Thread blockieren bis Nachrichtenaufnahme bereit
      ist, dies könnte aber schwierig sein wenn man asynchrone Kommunikation
      haben will
    * Wenn man durch Mapping kommuniziert könnte man Speicher markieren der
...
* Interaktions Probleme mit anderen Threads - Was ist wenn der Empfänger
  ...
  etwas senden will
    * Man könnte ähnliches zu Scheduling implementieren. Timer der den
...
* Wann endet die Nachricht? Was ist wenn das Ende nicht ankommt?
    ...
    * Man könnte alternativ die Länge der Nachricht anfangs mitgeben
